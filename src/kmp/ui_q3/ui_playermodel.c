...
static void PlayerModel_SaveChanges( void )
{
	...
	trap_Cvar_Set( "model_playerhead", s_playermodel.modelskin );
	trap_Cvar_Set( "model_team", s_playermodel.modelskin );
	trap_Cvar_Set( "model_teamheadmodel", s_playermodel.modelskin );
}
