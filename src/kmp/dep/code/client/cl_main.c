...
void CL_Init( void ) {
	...
	Cvar_Get ("model_playerhead", "sarge", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("model_team", "james", CVAR_USERINFO | CVAR_ARCHIVE );
	Cvar_Get ("model_teamheadmodel", "*james", CVAR_USERINFO | CVAR_ARCHIVE );
