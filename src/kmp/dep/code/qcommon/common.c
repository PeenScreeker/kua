...
//	Swap_Init ();
	...
	Cmd_AddCommand ("q", Com_Quit_f); //::KUA.add alias for quit
  ...
  // get dedicated here for proper hunk megs initialization
	...
	com_maxfps = Cvar_Get ("com_maxfps", "125", CVAR_ARCHIVE); //::KUA.chgd to 125, from 85
	com_blood = Cvar_Get ("com_blood", "0", CVAR_ARCHIVE); //::KUA.chgd to 0, from 1
