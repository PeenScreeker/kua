...
static cvarTable_t cvarTable[] = {
  {     &ui_run_fraglimit,      "ui_run_fraglimit",    "0",              CVAR_ARCHIVE}, //::KUA.chgd to "run" and 0, from "ffa" and 20
  {     &ui_run_timelimit,      "ui_run_timelimit",    "0",              CVAR_ARCHIVE}, //::KUA.chgd to "run"
